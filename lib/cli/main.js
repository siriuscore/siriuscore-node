...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `siriuscore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ siriuscore-node add wallet-service');
      console.log('    $ siriuscore-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ siriuscore-node remove wallet-service');
      console.log('    $ siriuscore-node remove insight-api');
      console.log();
    });
