...
/**
 * Will return the path and siriuscore-node configuration
...
function findConfig(cwd) {
  ...
  while (!fs.existsSync(path.resolve(directory, 'siriuscore-node.json'))) {
  ...
  return {
    path: directory,
    config: require(path.resolve(directory, 'siriuscore-node.json'))
  };
}
